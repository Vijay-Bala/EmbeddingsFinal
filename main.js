...
function funt(z) {
  setInterval(function () {
      ...
      if (x >= 0) {
          const a = Math.floor(x / (1000 * 60 * 60 * 24));
          const b = Math.floor((x % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
          const c = Math.floor((x % (1000 * 60 * 60)) / (1000 * 60));
          const d = Math.floor((x % (1000 * 60)) / 1000);

          // const y = (a < 10 ? "0" + a : a) + " : " + (b < 10 ? "0" + b : b) + " : " + (c < 10 ? "0" + c : c) + " : " + (d < 10 ? "0" + d : d);

          // document.querySelector(".timer").innerHTML = y;
          document.querySelector(".timer1").innerHTML = a;
          document.querySelector(".timer2").innerHTML = b;
          document.querySelector(".timer3").innerHTML = c;
          document.querySelector(".timer4").innerHTML = d;
      }
      // else document.querySelector(".timer").innerHTML = "00: 00: 00: 00";
  }, 1000);
}
const p = new Date("2024-03-15T08:00:00").getTime();
funt(p);